...
var _reflect = function _reflect(fn) {
	return function () {
		...
		args.push(function (error) {
			for (var _len22 = arguments.length, args2 = Array(_len22 > 1 ? _len22 - 1 : 0), _key22 = 1; _key22 < _len22; _key22++) {
				args2[_key22 - 1] = arguments[_key22];
			}
...
_seriesQ.prototype.__execute = _priorQ.prototype.__execute = function () {
	...
	_run_once(function (cb) {
		...
		_arEach(_this5.__workersList, function (worker, index) {
			if (worker === task) {
...
_cargoQ.prototype.__execute = function () {
	...
	(_workersList = this.__workersList).push.apply(_workersList, tasks);
