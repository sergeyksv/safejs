...
(function () {
	...
	var _queue = function (worker, concurrency) {
		...
		if (Object.defineProperty) {
			Object.defineProperty(self, '__worker', {
				enumerable: false,
				configurable: false,
				writable: false,
				value: worker
			...
			Object.defineProperty(self, '__workers', {
				enumerable: false,
				configurable: false,
				value: 0
			});

			Object.defineProperty(self, 'tasks', {
				enumerable: false,
				configurable: false,
				value: []
			});
	...
	_queue.prototype.__worker = _noop;
	...
	_queue.prototype.__insert = function (data, pos, callback) {
		...
		if (tlen) {
			if (self instanceof _priorQ) {
				...
				if (firstidx >= pos && pos < lastidx) {
					self.tasks.sort(function (a, b) { // reverse sort
		...
		for (var i = 0; self.concurrency >= self.__workers + i && i < arr.length && !self.paused; i++) {
			_later(function () { self.__execute(); });
		}
	}
