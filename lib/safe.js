...
!(function () {
	...
	var _isFunction = function (fn) {
		return fn && ((fn instanceof Function) || (_Object.prototype.toString.call(fn) === '[object Function]'));
	}
	...
	var _isObject = function (obj) {
		return obj && (_Object.prototype.toString.call(obj) === '[object Object]');
	}

	var _isArray = function (arr) {
		return arr && ((arr instanceof _Array) || (arr.constructor === _Array) || (_Object.prototype.toString.call(arr) === "[object Array]"));
	}

	var _isNotIterable = function (obj) {
	...
	var _arEach = /*_Array.prototype.forEach ? Function.prototype.call.bind(_Array.prototype.forEach) :*/ function (arr, iterator) {
		var i = -1,
			len = arr.length;
	...
	var _catcher = function (fn, self, args, callback) {
		try {
			...
			if (_options.debugger)
				_options.debugger(err, _argToArr.apply(0, arguments));
	...
	safe.debugger = function (fn) {
		_options.debugger = _isFunction(fn) ? fn : null;
	}
