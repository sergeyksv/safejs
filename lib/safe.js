...
safe.setOnErrorCaughtCallback = function(callback) {
	this.onErrorCaughtCallback = callback;
}

function errorCaught(err) {
	if(safe.onErrorCaughtCallback && typeof(safe.onErrorCaughtCallback) === 'function') {
		safe.onErrorCaughtCallback(err);
	}
}
