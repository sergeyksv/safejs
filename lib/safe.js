...
var _cargoQ = function (_queue4) {
	...
	function _cargoQ(worker, payload) {
		...
		var _this8 = _possibleConstructorReturn(this, (_cargoQ.__proto__ || Object.getPrototypeOf(_cargoQ)).call(this, worker, 1, 'Cargo'));
	...
	_createClass(_cargoQ, [{
		...
		value: function __execute() {
			...
			_run_once(function (cb) {
				...
				tasks.forEach(function (task) {
					for (var index = 0; index < _this9.__workersList.length; index++) {
						if (_this9.__workersList[index] === task) {
